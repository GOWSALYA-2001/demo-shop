...
const Index = () => {
  ...
  const headerData = [
    ...
    },
    {
      ...
      options: {
        customHeadLabelRender: () => (
          <span style={{ color: "black", fontWeight: "600",fontSize:"16px" }}>Product Name</span>
        ),
      },
    },
    { name: "price", label: "Price", 
      options: { customHeadLabelRender: () => (
      <span style={{ color: "black", fontWeight: "600",fontSize:"16px" }}>Price</span>
    ),filter: false } },
    ...
    { name: "description", label: "Desciption",
       options: { customHeadLabelRender: () => (
      <span style={{ color: "black", fontWeight: "600",fontSize:"16px" }}>Desciption</span>
    ),filter: false } },
  ...
  const callBackHome = (action, data, index) => {
    ...
    if (interchangeArr && interchangeArr.length > 0) {
